...
<head>
    ...
    <!-- Variables globales para JavaScript — PHP procesa esto, auth.js lo consume -->
    <script>
    ...
    <script>
        tailwind.config = {
            ...
            safelist: [
                'text-req-ok', 'text-req-pending',
                'bg-req-ok',   'bg-req-pending',
            ]
        }
    </script>
    ...
    <!-- JS de autenticación — en el head para que las funciones estén disponibles
         antes de que el contenido de la vista las llame -->
